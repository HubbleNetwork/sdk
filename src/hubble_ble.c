...
#define DEBUG(...) HUBBLE_LOG(HUBBLE_LOG_DEBUG, __VA_ARGS__)
#define INFO(...)  HUBBLE_LOG(HUBBLE_LOG_INFO, __VA_ARGS__)
#define ERR(...)   HUBBLE_LOG(HUBBLE_LOG_ERR, __VA_ARGS__)
...
int hubble_ble_init(uint64_t utc_time)
{
	...
	INFO("Hubble BLE Network initialized\n");
