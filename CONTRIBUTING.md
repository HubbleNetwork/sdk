...
- Check the [Hubble Network SDK Documentation](https://docs.hubblenetwork.com/docs/device-sdk/intro)
...
- Read the [documentation](https://docs.hubblenetwork.com/docs/device-sdk/intro) carefully
...
- Review the [documentation](https://docs.hubblenetwork.com/docs/device-sdk/intro)
