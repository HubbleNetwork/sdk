...
/* The center frequency for channel 0 is 2482208625
 * -> f_base = 2482208625 - (32 * 400) = 2482192625
 * Each channel is 25.75 kHz
 * --> offset = 25.75k / 500 ~= 52 steps (round)
 * Base is set at 24822 MHz,
 * (2482192625 - 2.482e9) / 500 = 385 steps
 */
#define HUBBLE_BASE_FREQUENCY           2482U
#define HUBBLE_CHANNEL_OFFSET(_channel) (((_channel) * 52) + 385)
