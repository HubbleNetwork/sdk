...
/**
 * @file port_types.h
 * @brief Zephyr-specific type definitions for the Hubble Network SDK port
 *
 * This header file defines platform-specific types used by the Hubble Network SDK
 * when running on Zephyr RTOS. These types provide the concrete implementation
...
#ifndef PORT_ZEPHYR_PORT_TYPES_H
#define PORT_ZEPHYR_PORT_TYPES_H
...
/**
 * @brief Zephyr-specific timer structure implementation
 *
 * This structure provides the Zephyr implementation of the abstract
 * hubble_timer type. It wraps the Zephyr kernel timer (k_timer) and adds
 * callback function and user data fields required by the Hubble SDK timer API.
 */
struct hubble_timer {
	/** @brief Underlying Zephyr kernel timer instance */
	struct k_timer zephyr_timer;
...
#endif /* PORT_ZEPHYR_PORT_TYPES_H */
